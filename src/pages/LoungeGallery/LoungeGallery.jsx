    ...
    <div className="bg-custom-gradient-2 min-h-screen overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <h1 className="text-4xl font-bold text-center text-white">Lounge Gallery</h1>
        </div>
        ...
        <div className="bg-gray-900/50 p-6 rounded-lg mb-12">
          <p className="text-lg text-amber-400 text-center leading-relaxed max-w-3xl mx-auto">
            Transform your event space into a sophisticated haven with our premium lounge furniture collection. 
            From modern LED-lit pieces to timeless statement furniture, our versatile selection allows you to 
            create intimate conversation areas, VIP sections, or complete lounge environments that will leave 
